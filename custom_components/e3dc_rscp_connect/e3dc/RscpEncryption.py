...
class RscpEncryption:
    ...
    def encrypt(self, plaintext : bytes) -> bytes:
        cipher = py3rijndael.RijndaelCbc(self.__key, self.__encryptionIV, padding=py3rijndael.ZeroPadding(RscpEncryption.BLOCK_SIZE), block_size=RscpEncryption.BLOCK_SIZE)
    ...
    def decrypt(self, ciphertext : bytes) -> bytes:
        ...
        cipher = py3rijndael.RijndaelCbc(self.__key, self.__decryptionIV, padding=NoPadding(RscpEncryption.BLOCK_SIZE), block_size=RscpEncryption.BLOCK_SIZE)
